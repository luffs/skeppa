...
// /api, /ws and /live to the backend. Keeping it same-origin means the
// SameSite=Lax session cookie is sent on every request and both upgrades — a
// cross-site target (e.g. a deployed VPS) would drop the Lax cookie and 401
// everything.
